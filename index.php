...
<head>
    ...
    <title>DBT - Inicio 2 AAAAbu</title>
    ...
    <nav class="navbar">
        ...
        <div class="nav-center">
            <div class="nav-links">
                ...
                <a class="nav-link " href="tradeMarket.php">Explorar trocas</a>
            </div>
        </div>
        <div class="nav-right">
            <div class="user-menu">
...
<main class="page-shell">
    <section class="hero">
        <div class="hero-card hero-copy">
            ...
            <div class="hero-actions">
                ...
                <a class="btn-outline" href="SignUp.php">Criar conta</a>
            </div>
        </div>
    ...
    <section class="section">
        <div class="section-header">
            <div>
                <h2>Como funciona</h2>
                <p class="section-subtitle">O fluxo foi pensado para ficar simples e rápido.</p>
            </div>
        </div>
        <div class="steps">
    ...
    <section class="section">
        <div class="section-header">
            <div>
                ...
                <p class="section-subtitle">Cards simples para mostrar o conceito da plataforma.</p>
            </div>
